      ...
      >
        ...
        <div className="rounded-3xl bg-card border border-border p-8 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <button
              type="button"
              onClick={() => setError("Google sign-in is not available in the demo. Please use email.")}
              className="flex items-center justify-center gap-2 rounded-xl border border-border bg-background px-4 py-2.5 text-sm font-medium text-foreground hover:bg-muted transition-colors"
            >
            ...
            <button
              type="button"
              onClick={() => setError("Apple sign-in is not available in the demo. Please use email.")}
              className="flex items-center justify-center gap-2 rounded-xl border border-border bg-background px-4 py-2.5 text-sm font-medium text-foreground hover:bg-muted transition-colors"
            >
            ...
            >
              ...
              {mode === "login" && (
                <div className="flex justify-end">
                  <button
                    type="button"
                    onClick={() => setError("Password reset is not available in the demo. Use: alex@verafunddemo.com / demo123")}
